...
{
    public partial class ucSubServer : UserControl
    {
        public static ucSubServer mainInstance = null;
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            ...
            Final.frmSetup.instance.Controls["panelContainer"].Controls["ucSubServer1"].Visible = false;
        }
        ...
        public void start_scanning()
        {
            ...
            lblInstallationType.Text = type + " Installation";
        }

        private void btnFinish_Click(object sender, EventArgs e)
        {
            hasError = false;
            if (string.IsNullOrEmpty(cbLocation.Text) || cbLocation.Text == "--Select department--" || cbLocation.SelectedIndex == -1 || cbLocation.SelectedIndex == 0)
            {
                hasError = true;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            setup.department_id = Convert.ToInt32(cbLocation.SelectedValue);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    MessageBox.Show(type + " has been set-up!", "Setup", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                    setup.add_directory();
                                }
                            }
                        }
